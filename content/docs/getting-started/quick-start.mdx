...
> For custom theming, use the [Lite version](../guide/widget#full-vs-lite) (`aigcs-lite.js`) plus your own CSS. See [Widget Embedding](../guide/widget#full-vs-lite) for details.
